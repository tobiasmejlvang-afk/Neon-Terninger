'use strict';
const CACHE = 'neon-terninger-v6-pack-designer';
const ASSETS = ['./', './index.html', './style.css', './modes.css', './packs.css', './app.js', './modes.js', './packs.js', './icon.svg', './icon-192.png', './icon-512.png', './manifest.webmanifest'];
